...
import { ConfigProvider, Form, Input, InputNumber, Select } from "antd";
...
const EditEmployeeModal: React.FC<EditEmployeeModalProps> = ({
  ...
  if (isEmbedded) {
    return (
      <div style={{ width: "100%" }}> {/* Add a container with 100% width */}
        <ConfigProvider
          theme={{
            token: {
        ...
        >
          ...
          <Form
            ...
            className="bg-white rounded-lg shadow-sm font-['Squada_One'] w-full"
          >
            {error ? (
              ...
              <div className="space-y-8 p-6">
                ...
                <div className="grid grid-cols-2 gap-8 w-full">
                  <div className="bg-gray-50/70 p-6 rounded-xl shadow-sm w-full">
                    ...
                    <div className="space-y-5">
                      ...
                      <Form.Item
                        ...
                        rules={[
                          ...
                          {
                            validator(_, value) {
                              if (value && value >= 3000000) {
                                return Promise.resolve();
                              }
                              return Promise.reject(
                                new Error("Salary must be more than 3,000,000")
                              );
                            },
                          },
                        ]}
                      >
                        <InputNumber
                          ...
                          className="w-full rounded-lg py-2 font-['Squada_One']"
                        />
                      </Form.Item>
                    </div>
                  </div>
            ...
            {/* Footer */}
            <div className="px-6 py-4 border-t bg-white rounded-b-lg w-full">
