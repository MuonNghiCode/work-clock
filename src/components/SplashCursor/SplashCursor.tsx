...
export default function SplashCursor({
  SIM_RESOLUTION = 32, // Giảm độ phân giải
  DYE_RESOLUTION = 120, // Giảm độ phân giải
  CAPTURE_RESOLUTION = 124, // Giảm độ phân giải
  DENSITY_DISSIPATION = 3.5,
  VELOCITY_DISSIPATION = 2,
  PRESSURE = 0.1,
  PRESSURE_ITERATIONS = 5, // Giảm số lần lặp
  CURL = 3,
  SPLAT_RADIUS = 0.05, // Giảm bán kính
  SPLAT_FORCE = 1000, // Giảm lực
  SHADING = true,
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      const colors = [
        { r: 1, g: 0.57, b: 0.3 }, // #ff914d
        { r: 1, g: 0.72, b: 0.54 }, // #feb78a
        { r: 0.84, g: 0.46, b: 0.28 }, // #d67548
        { r: 1, g: 1, b: 1 }, // #ffffff
      ];
